          ...
          {dict?.items.map((item, index) => {
            ...
            return (
              <FadeIn key={index} delay={index * 0.1} className="h-full">
                <div className="bg-background border border-border p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow h-full flex flex-col items-center text-center md:items-start md:text-left">
